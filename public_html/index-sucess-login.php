        ...
        <div class="container justify-content-center">
            <div class="collapse navbar-collapse flex-grow-0 a" id="navbarCollapse">
                <div class="navbar-nav p-4 p-lg-0">
                    ...
                    <a href="" class="nav-item nav-link">Preços</a>  
                </div>
            </div>
        </div>
            ...
            <div class="collapse navbar-collapse flex-grow-0 a" id="navbarCollapse">
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <img class="img-profile rounded-circle" src="img/user_profile.svg">
                    </a>
                    <!-- Dropdown - User Information -->
                    <div class="dropdown-menu-profile dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
